      ...
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center px-10 sm:px-16 py-16">
        <small className="text-gray-800 mb-6 sm:mb-0">
          ...
          <a
            ...
            className="font-bold underline font-serif ml-1"
          >
            Maxime Dubourg
          </a>
        </small>
        ...
        <div className="flex items-center">
          <a
            href="https://github.com/mdubourg001/klean-canvas"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
              ...
              className="feather feather-github text-gray-800"
            >
          ...
          >
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="feather feather-twitter text-gray-800 ml-6"
            >
